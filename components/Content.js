...
const content = props => {
    ...
    if(config.host == "" || config.DAO.host == "" || config.DAO.user == "" || config.DAO.password == "" || config.DAO.database == "")
        prepare = true
    ...
    html.innerHTML = `
        <div class="layer hide">
            <div id="alert">
                ...
                <span>É preciso preencher as configurações para iniciar a aplicação</span>
            </div>
        </div>
        <header>
